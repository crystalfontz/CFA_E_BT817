...
#define display              (paste display name here)

//Display names:

#define CFA480480E0040TN  (4)// 4" Square, 480x480, non-touch
#define CFA480480E0040TW  (4)// 4" Square, 480x480, capacitive touch

#define CFA480272E0043SN  (431) // 4.3" 480x272, non-touch
#define CFA480272E0043SR  (431) // 4.3" 480x272, resistive touch
#define CFA480272E0043SC  (431) // 4.3" 480x272, capacitive touch

#define CFA800480E0043SN  (432) // 4.3" 800x480, non-touch
#define CFA800480E0043SR  (432) // 4.3" 800x480, resistive touch
#define CFA800480E0043SC  (432) // 4.3" 800x480, capacitive touch

#define CFA800480E3050SN  (5) // 5.0" 800x480, non-touch
#define CFA800480E3050SR  (5) // 5.0" 800x480, resistive touch
#define CFA800480E3050SC  (5) // 5.0" 800x480, capacitive touch
#define CFA800480E3050SW  (5) // 5.0" 800x480, overhanging capacitive touch

#define CFAF1024600B0070SCA1  (7) // 7.0", 1024x600, capacitive touch
...
// CFA10100 defines
...
#if ((display == CFA800480E3050SN) ||(display == CFA800480E3050SC) ||(display == CFA800480E3050SR) || (display == CFA800480E3050SW))
  ...
  #define HPP   (377)    // Horizontal Pixel Padding (calculate using Calculation_of_Timing.xlsx)
...
#endif //((display == CFA800480E0050SN) ||(display == CFA800480E0050SC) ||(display == CFA800480E0050SR) || (display == CFA800480E0050SW))
//================================================================
// CFA10108 defines

#if (display == CFAF1024600B0070SCA1)
  // Define RGB output pins order, determined by PCB layout
...
#endif //(display == CFAF1024600B0070SCA1)


// //================================================================
// CFA10118 defines
#if ((display == CFA480480E0040TN)|| (display == CFA480480E0040TW))
  // Define RGB output pins order, determined by PCB layout
...
#endif //(display == CFA480480E0040TN)|| (display == CFA480480E0040TW)

#if ((display == CFA480272E0043SN) || (display == CFA480272E0043SR) || (display == CFA480272E0043SC)) 
  // Define RGB output pins order, determined by PCB layout
  #define LCD_SWIZZLE      (0x0)
...
#endif //((display == CFA480272E0043TN) || (display == CFA480272E0043TR) || (display == CFA480272E0043TC)) 


#if ((display == CFA800480E0043SN) || (display == CFA800480E0043SR) || (display == CFA800480E0043SC)) 
  // Define RGB output pins order, determined by PCB layout
  #define LCD_SWIZZLE      (0x0)
...
#endif //((display == CFA800480E0043TN) || (display == CFA800480E0043TR) || (display == CFA800480E0043TC)) 
